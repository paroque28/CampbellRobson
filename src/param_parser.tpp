...
const short DEFAULT_IMAGE_COLS = 512;
const short DEFAULT_IMAGE_ROWS = 512;
...
void param_parser (int ac, char** av)
{
  ...
  desc.add_options ()
      ("help,h", "help")
      ("rows,r", po::value<int>()->default_value(DEFAULT_IMAGE_ROWS), "rows")
      ("cols,c", po::value<int>()->default_value(DEFAULT_IMAGE_COLS), "cols")
